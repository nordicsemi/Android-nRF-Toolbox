...
val DF_SERVICE_UUID = Uuid.parse("21490000-494a-4573-98af-f126af76f490")
...
val CHANNEL_SOUND_SERVICE_UUID = Uuid.parse("0000185B-0000-1000-8000-00805F9B34FB")
...
val EXPERIMENTAL_BUTTONLESS_DFU_SERVICE_UUID = Uuid.parse("E2A00001-EC31-4EC3-A97A-1C34D87E9878")
